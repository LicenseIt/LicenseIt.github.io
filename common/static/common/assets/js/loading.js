...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["Searching in ASCAP", "Searching in BMI", "Searching in SOCAN", "Searching in Sony", "Searching in Warner Music", "Searching in Universal Music", "Searching in MusicBrainz", "Searching in AllMusic", "Searching in Discogs","Searching in The Echo Nest", "Searching in Quantone"]);
